...
const navigation: NavItem[] = [
  ...
  { name: 'Posts', href: '/dashboard/posts', icon: DocumentTextIcon, section: 'main' },
  { name: 'Write Post', href: '/dashboard/submit-post', icon: PencilSquareIcon, section: 'main' },
  { name: 'Media', href: '/dashboard/media', icon: PhotoIcon, section: 'content' },
  { name: 'Categories', href: '/dashboard/categories', icon: FolderIcon, section: 'content' },
  { name: 'Tags', href: '/dashboard/tags', icon: TagIcon, section: 'content' },
  { name: 'Settings', href: '/dashboard/edit-profile', icon: Cog6ToothIcon, section: 'account' },
  { name: 'Billing', href: '/dashboard/billing-address', icon: CreditCardIcon, section: 'account' },
]
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <Dropdown>
              ...
              <DropdownMenu>
                ...
                <DropdownItem href="/">View Site</DropdownItem>
