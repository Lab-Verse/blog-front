      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            // Typography
            'text-left text-base/6 text-neutral-950 placeholder:text-neutral-500 sm:text-sm/6 rtl:text-right dark:text-white forced-colors:text-[CanvasText]',
            // Border
...
export function ListboxLabel({ className, ...props }: React.ComponentPropsWithoutRef<'span'>) {
  return <span {...props} className={clsx(className, 'ms-2.5 truncate first:ms-0 sm:ms-2 sm:first:ms-0')} />
}
